...
// floor tile - red otherwise), and turns it into a Magazine tile on click. Clicking the
...
public class NewBuildButton : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        bool canBuildHere = viewedBase != null && viewedBase.IsOwnedByLocalPlayer && viewedBase.CanBuildMagazine;
    ...
    {
        PlayerBase viewedBase = ViewManager.CurrentView == ViewMode.Base ? ViewManager.ViewedBase : null;
        if (viewedBase == null || !viewedBase.IsOwnedByLocalPlayer || !viewedBase.CanBuildMagazine) return;
